...
/**
 * Every use case a worker is allowed to run, with the json schema of its input and output.
 * `createTenant` and `listTenants` are intentionally absent: a worker never creates nor lists tenants.
 */
